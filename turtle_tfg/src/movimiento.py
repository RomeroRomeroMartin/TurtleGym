...
for i in range(500):
	...
	for i in range(eps):
	    ...
	    '''key=str(raw_input('Episodio terminado, pulsa ENTER para siguiente episodio, pusla q para salir: '))
	    print(key)
        ...
        f=open('/home/ap/grupo_primero_0/catkin_ws/src/turtle_tfg/data/AccionesQlearning.txt','a')
	f.write(str(list_acciones))
	f.write('\n')
	f.close()
	data=[Q[:len(visited_states),:],visited_states]
	#with open('/home/ap/grupo_primero_0/catkin_ws/src/turtle_tfg/models/Qlear3x3_20.pkl','wb') as f:
	    #pickle.dump(data,f)
